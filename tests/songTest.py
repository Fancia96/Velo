...
class SongTest(unittest.TestCase):
    ...
    def test_first_verse_not_equal(self):
        vers_1 = "2134243242"
        self.assertNotEqual(return_verse(1), vers_1)

    def test_fourth_to_sixth_verse_not_equal(self):
        vers_4_to_6 = "23467876427"

        self.assertNotEqual(return_verse(4, 6), vers_4_to_6)

    def test_return_whole_song_not_equal(self):
        whole_song = "2342342342"

        self.assertNotEqual(return_whole_song(), whole_song)

    def test_one_verse_given_wrong_value(self):
        self.assertRaises(Exception, return_verse, "a")

    def test_fourth_to_sixth_given_both_wrong_values(self):
        self.assertRaises(Exception, return_verse, "a", "b")

    def test_fourth_to_sixth_given_first_wrong_values(self):
        self.assertRaises(Exception, return_verse, "a", 1)

    def test_fourth_to_sixth_given_second_wrong_values(self):
        self.assertRaises(Exception, return_verse, 1, "a")
